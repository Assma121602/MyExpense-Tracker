...
<head>
	...
	<title>ISA Expense Tracker</title>
	<style>
				...
				<div class="card">
					<div class="card-body">
						<form action="" method="POST" class="login-email">
							<p class="login-text" style="font-size: 2rem; font-weight: 800;">Login Form</p><br></br>
							...
							<div class="input-group">
							<input type="checkbox" checked="checked" name= "remember">Show Password </label><br>
							</div>
							<div class="input-group">
							<button type="button" class="cancelbtn">Cancel</button>
								<a href="dashboard.php"><button name="submit" class="btn">Login</button><br>
								<span class="psw">Forgot password?</span><br></br>
